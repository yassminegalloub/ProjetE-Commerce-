<div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          ...
          <a class="navbar-brand" href=""><h2 >BOUTIQUE <em style="color:red;">SHOP</em></h2></a>
        ...
        <ul class="nav">
            ...
            <div class="profile-desc">
              <div class="profile-pic">
                <div class="count-indicator">
                  <img class="img-xs rounded-circle " src="admin/assets/images/faces/admin.png" alt="">
                  <span class="count bg-success"></span>
                </div>
                <div class="profile-name">
                  <h5 class="mb-0 font-weight-normal">Administrateur</h5>
                  <span>Super Member</span>
                </div>
              </div>
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="{{url('showmessage')}}">
              ...
              <span class="menu-title">Show all Messages</span>
            </a>
          </li>
        </ul>
      </nav>